...
print("C:/DOCS/MAYA/2024/SCRIPTS/")
...
class main_ui(QWidget):
    ...
    def initUI(self):
        ...
        UI_FILE = path + "/file_imports/main_window.ui"
    ...
    def addPressed(self):
        try:
            ...
            possible_arm = ['jnt_rig_clavicle','jnt_rig_shoulder','jnt_rig_arm']
            possible_leg = ['jnt_rig_hip','jnt_rig_fema','jnt_rig_pelvis']
    ...
    def use_autorig_pressed(self):
        global ui_data
        ui_data = {'jnt_rig_clavicle_r': [4, 'False', 'False', 'jnt_rig_chest', 'arm'],
                   'jnt_rig_clavicle_l': [4, 'False', 'False', 'jnt_rig_chest', 'arm'],
                   'jnt_rig_hip_r': [4, 'False', 'False', 'jnt_rig_pelvis', 'leg'],
                   'jnt_rig_hip_l': [4, 'False', 'False', 'jnt_rig_pelvis', 'leg'],
                   #'jnt_rig_pelvis': [4, 'False', 'False', 'jnt_rig_COG', 'spine']
                   }
        return ui_data
    ...
    def load_autorig_pressed(self):
        path = system_get_file_location.get_loc()
        print(f"file path {path}")
        SKELETON_FILE = path + "/file_imports/skeleton.ma"
        try:
